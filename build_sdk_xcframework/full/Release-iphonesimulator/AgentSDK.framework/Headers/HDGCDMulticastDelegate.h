...
@class HDGCDMulticastDelegateEnumerator;
...
@interface HDGCDMulticastDelegate : NSObject
...
- (HDGCDMulticastDelegateEnumerator *)delegateEnumerator;

@end


@interface HDGCDMulticastDelegateEnumerator : NSObject
