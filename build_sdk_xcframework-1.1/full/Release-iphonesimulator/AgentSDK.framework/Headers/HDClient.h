...
#import "HDOnlineManager.h"
#import "HDVECManager.h"
#import "HDOnlineWhiteboardManager.h"
/*!
 * SDK Client
 */
 ...
 *  call module
 */
@property (nonatomic, strong, readonly) HDOnlineManager *hlCallManager;
/*!
 *  \~chinese
 *  白板通讯模块
 *
 ...
 *  Whiteboard module
 */
@property (nonatomic, strong, readonly) HDOnlineWhiteboardManager *whiteboardManager;
 ...
 *   VEC module
 */
@property (nonatomic, strong, readonly) HDVECManager *vecCallManager;
