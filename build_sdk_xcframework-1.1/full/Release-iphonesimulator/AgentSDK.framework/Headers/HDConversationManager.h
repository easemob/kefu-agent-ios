 ...
 * 加载消息 新接口
 */
- (void)loadMessageNewCompletion:(void(^)(NSArray <HDMessage *> *messages,HDError *error))completion;
...
// 获取访客地址信息
- (void)asyncFetchCustomerInfo:(void(^)(HCustomerLocalModel *model, HDError *error))aCompletion;
