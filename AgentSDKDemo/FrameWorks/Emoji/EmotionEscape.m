...
@implementation EmotionEscape

static EmotionEscape *_sharedInstance = nil;

+ (EmotionEscape *)sharedInstance
{
    if (_sharedInstance == nil)
    {
        @synchronized(self) {
            _sharedInstance = [[EmotionEscape alloc] init];
        }
    }
