...
//    int maxRow = 4;
//    int maxCol = 8;
//    CGFloat itemWidth = KScreenWidth / 8;
...
//    
//    NSInteger totalPage = [_faces count]%31 == 0 ? [_faces count]/31: [_faces count]/31 + 1;
//    [_scrollview setContentSize:CGSizeMake(totalPage * CGRectGetWidth(self.frame), CGRectGetHeight(self.frame) - itemHeight)];
//    
//    _pageControl.currentPage = 0;
//    _pageControl.numberOfPages = totalPage;
//    _pageControl.frame = CGRectMake(0, CGRectGetHeight(self.frame) - 48, CGRectGetWidth(self.frame), 48.f);
