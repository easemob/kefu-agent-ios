//
//  HDSuperviseManagerViewController.m
//  AgentSDKDemo
//
...
#import "KFSuperviseDetailViewController.h"

@interface HDSuperviseManagerViewController ()

@end

@implementation HDSuperviseManagerViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    HDSuperviseCell *cell = [tableView dequeueReusableCellWithIdentifier:@"supervise"];
    if (cell == nil) {
        cell = [[HDSuperviseCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"supervise"];
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    KFSuperviseDetailViewController *detailVC = [[KFSuperviseDetailViewController alloc] init];
