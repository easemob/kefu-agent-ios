//
//  KFSuperviseDetailViewController.m
//  AgentSDKDemo
//
...
@interface KFSuperviseDetailViewController ()

@end

@implementation KFSuperviseDetailViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    KFSuperviseDetailCell *cell = [tableView dequeueReusableCellWithIdentifier:@"supervise"];
    if (cell == nil) {
        cell = [[KFSuperviseDetailCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"supervise"];
    }
