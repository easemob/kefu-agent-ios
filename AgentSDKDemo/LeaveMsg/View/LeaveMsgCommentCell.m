...
@implementation LeaveMsgCommentCell
    ...
    reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        // Initialization code
        _timeLabel = [[UILabel alloc] initWithFrame:CGRectMake(KScreenWidth - 120, 7, 115, 16)];
...
-(void)layoutSubviews{
    ...
    CGFloat height = [LeaveMsgCommentCell _heightForContent:_detailMsg];
    if (_model && height > 0) {
...
{
    return 60.f + [LeaveMsgCommentCell _heightForModel:model];
}
