...
//    [[HDVECAgoraCallManager shareInstance] vec_GetVECAgentStatusCompletion:^(id  _Nonnull responseObject, HDError * _Nonnull error) {
//
//
//        NSLog(@"===%@",responseObject);
//
