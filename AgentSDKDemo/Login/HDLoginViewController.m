...
- (void)loginButtonAction:(id)sender
{
    ...
    [[HDNetworkManager shareInstance] asyncLoginWithUsername:_usernameField.text password:_passwordField.text hidingLogin:_hiddenButton.selected completion:^(id responseObject, HDError *error) {
        [weakSelf hideHud];
        if (error) {
