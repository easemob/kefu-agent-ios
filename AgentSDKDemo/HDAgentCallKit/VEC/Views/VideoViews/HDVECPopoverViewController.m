...
@implementation HDVECPopoverViewControllerCellItem

@end

@implementation HDVECPopoverViewController
...
//    self.tableView.separatorStyle = UITableViewCellSeparatorStyleNone;
    HDVECPopoverViewControllerCellItem * item =self.dataArray[indexPath.row];
