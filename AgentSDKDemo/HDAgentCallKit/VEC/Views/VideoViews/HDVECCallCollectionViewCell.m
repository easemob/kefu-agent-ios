...
@interface HDVECCallCollectionViewCell ()
@property (nonatomic, strong) UILabel *nickNameLabel;
@property (nonatomic, strong) UIButton *muteBtn;

@property (nonatomic, strong) UIImageView *bgImgView;
@end
@implementation HDVECCallCollectionViewCell
...
- (void)setItem:(HDVECCallCollectionViewCellItem *)item {
    _item = item;
...
- (void) closeVideoAddView:(HDVECCallCollectionViewCellItem *)item{
