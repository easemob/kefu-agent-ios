...
- (NSMutableArray *)hd_buttonFromArrBarModels:(NSArray<HDVECControlBarModel *> *)barModelArr view:(UIView *)view withButtonType:(HDControlBarButtonStyle)style{
